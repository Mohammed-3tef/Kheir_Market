...
IF EXISTS (SELECT name FROM sys.databases WHERE name = 'Kheir_Market')
BEGIN
    ALTER DATABASE Kheir_Market SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Kheir_Market;
END
GO
CREATE DATABASE Kheir_Market;
GO
USE Kheir_Market;
GO
