...
namespace Kheir_Market.pages.customer
{
    ...
    public partial class OrderManagement : Form
    {
        ...
        {
            string connectionString = "Data Source=.;Initial Catalog=Kheir_Market;Integrated Security=True;";
        ...
        {
            this.dEPARTMENTTableAdapter.Fill(this.Kheir_Market_DataSet.DEPARTMENT);
